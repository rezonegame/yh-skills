...
适用关键词：文档、出版物、杂志、菜单、报纸、课本、药方、笔记、书页、手册、规则书、排版页
适合任务：出版物页面、规则书、帮助卡、杂志/报纸版式、菜单、笔记、文档视觉
不适合任务：纯商品海报、复杂 UI、纯场景插画、Logo
可作为主库：最终交付物是页面、手册、书页或出版排版
可作为辅助库：为桌游规则书、信息图、海报提供出版版式和文字层级
常见交叉库：图表与信息可视化、海报与排版、历史与古风题材、UI与界面
必要槽位：文档类型、页面尺寸、内容层级、语言、是否需真实可读文字、风格
可默认槽位：默认简体中文；文字量比海报可多但仍需分层；比例按纸张
必须确认槽位：是否是可读页面还是视觉风格图；是否需要印刷约束
优先输出形态：规则书页面、帮助卡、杂志页、菜单、报纸、笔记、书籍内页
默认比例：A4/A5 竖版；杂志 3:4；横向手册 16:9
默认语言：默认简体中文；用户要求英文/双语时再加入
常见误判：不要把文档出版物做成海报；大量小字在图像模型里容易不可读
关联 recipe / template：structured-templates.md#publication；recipes/boardgame-rulebook.md；recipes/infographic.md
检索建议：优先检索文档类型、版式、纸张、文字层级、用途
...
![case168.jpg](images/case168.jpg)
...
![case201.jpg](images/case201.jpg)
...
![case266.jpg](images/case266.jpg)
...
![case293.jpg](images/case293.jpg)
...
![case294.jpg](images/case294.jpg)
...
![case295.jpg](images/case295.jpg)
...
![case297.jpg](images/case297.jpg)
...
![case300.jpg](images/case300.jpg)
