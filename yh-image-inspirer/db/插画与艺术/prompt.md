...
适用关键词：插画、漫画、动漫、二次元、手绘、水彩、水墨、绘本、艺术、地图、国风、像素艺术
适合任务：插画作品、手绘地图、绘本风画面、艺术海报、角色插画、风格化视觉
不适合任务：真实商品摄影、电商详情页、严谨 UI 截图、纯品牌 Logo
可作为主库：最终交付物以插画/艺术风格表达为核心
可作为辅助库：为人物、信息图、历史古风、海报、场景叙事提供风格语言
常见交叉库：人物与角色、图表与信息可视化、历史与古风题材、海报与排版、场景与叙事
必要槽位：主题、主体、画风、用途、比例、是否需要文字、参考图保留项
可默认槽位：默认简体中文少量文字或无文字；比例按交付物；风格明确
必须确认槽位：是否是独立插画还是商业海报/信息图辅助风格；是否需要保留参考主体
优先输出形态：插画、手绘地图、绘本图、艺术海报、风格化角色/场景
默认比例：插画 1:1/4:5；地图 1:1；海报 4:5/3:4
默认语言：默认无文字；需要文字时简体中文
常见误判：不要因选择插画库而忽略最终交付物的信息层级或商品保真
关联 recipe / template：structured-templates.md#illustration；recipes/infographic.md；structured-templates.md#poster
检索建议：优先检索画风、媒介、主体、题材、用途
