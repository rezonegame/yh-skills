...
适用关键词：摄影、写实、人像、写真、自拍、时尚大片、商业摄影、产品摄影、棚拍、电影级、超写实
适合任务：真人摄影感、产品摄影、商业大片、人像写真、写实场景、参考图身份保留
不适合任务：纯 UI、Logo、扁平信息图、印刷卡牌正面、需要大量文字的海报
可作为主库：最终交付物以照片级真实感或摄影语言为核心
可作为辅助库：为商品、海报、场景叙事、人物提供写实光影和摄影构图
常见交叉库：商品与电商、人物与角色、场景与叙事、海报与排版、建筑与空间
必要槽位：主体、场景、镜头/光线、比例、是否严格保留参考人物/产品、禁忌
可默认槽位：默认无文字；真实材质；自然光影或商业棚拍；比例按用途
必须确认槽位：是否允许改变人物身份/产品包装；是摄影图还是带排版的广告海报
优先输出形态：人像摄影、商业摄影、产品摄影、写实场景、电影感画面
默认比例：人像 3:4/4:5；横向场景 16:9；商业海报 4:5
默认语言：默认不加文字；广告海报需求时用简体中文
常见误判：不要把参考人物磨皮改脸；不要把产品摄影误做成没有信息层级的电商海报
关联 recipe / template：structured-templates.md#photo；recipes/ecommerce-poster.md；structured-templates.md#scene
检索建议：优先检索主体、镜头、光线、场景、真实材质、保留锚点
...
**来源：** [@Shinning1010](https://x.com/Shinning1010/status/2050693240253214894)

![泼洒抹茶街头手机照片](images/case376.jpg)
