...
适用关键词：建筑、室内、空间、城市、地标、展厅、店铺、房间、景观、舞台、摊位、展位
适合任务：建筑渲染、室内空间、城市地标、展会空间、线下活动场景、空间概念图
不适合任务：纯人物立绘、纯商品主图、Logo、卡牌正面设计
可作为主库：最终交付物以空间、建筑或环境设计为核心
可作为辅助库：为海报、商品、线下活动图提供场景背景、展位和空间语境
常见交叉库：场景与叙事、海报与排版、商品与电商、摄影与写实
必要槽位：空间类型、用途、风格、主体、视角、是否有人/商品、比例
可默认槽位：默认写实空间或概念渲染；无文字；视角清晰
必须确认槽位：是空间主图还是海报背景；是否要真实可落地设计
优先输出形态：建筑渲染、室内图、城市地标、展位/摊位、活动空间
默认比例：空间横向 16:9；海报背景 4:5/9:16；方形展示 1:1
默认语言：默认不加文字；活动海报叠字时用简体中文
常见误判：不要把空间背景做成主角，除非最终交付物就是空间设计
关联 recipe / template：structured-templates.md#space；structured-templates.md#scene
检索建议：优先检索空间类型、视角、风格、场景用途、主视觉关系
...
![case120.jpg](images/case120.jpg)
...
![case121.jpg](images/case121.jpg)
...
![case127.jpg](images/case127.jpg)
...
![case128.jpg](images/case128.jpg)
