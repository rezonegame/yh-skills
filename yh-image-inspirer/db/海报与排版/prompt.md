...
> 91 个原有案例 + 8 个 Mondo 风格专题案例 + 2 个桌游宣传海报参考集合


## Metadata

适用关键词：海报、排版、封面、宣传、Campaign、活动、线下海报、公众号首图、电影海报、Mondo、书籍封面、专辑封面
适合任务：宣传海报、活动海报、线下印刷海报、封面、Campaign 主视觉、Mondo 风格、社媒首图
不适合任务：纯 UI 操作界面、纯商品详情页、卡牌正面、无排版需求的摄影图
可作为主库：最终交付物是海报、封面、宣传主视觉或排版作品
可作为辅助库：为商品、桌游、人物、场景、信息图提供版式、标题层级和风格构图
常见交叉库：商品与电商、人物与角色、场景与叙事、图表与信息可视化、插画与艺术、品牌与标志
必要槽位：用途、主视觉、比例/尺寸、主标题、副标题、卖点/活动信息、是否印刷、参考图锚点
可默认槽位：线下海报默认竖版 A3/A2 感；简体中文；1 主标题+1 副标题+3 短标签；高对比
必须确认槽位：传播目的是销售、招募、告知还是品牌曝光；是否需要时间地点/二维码；是否严格保留参考产品
优先输出形态：线下海报、社媒海报、电影海报、书籍封面、专辑封面、公众号首图
默认比例：线下海报 3:4/4:5；社媒 4:5/1:1；横向首图 16:9
默认语言：默认简体中文；除非用户明确要求，不主动加入英文标题
常见误判：海报不等于大字堆叠；线下海报要遵守 3 秒法则和观看距离
关联 recipe / template：structured-templates.md#poster；references/layout-composition-patterns.md；references/poster-artist-styles.md；references/poster-composition-patterns.md；references/poster-genre-templates.md；recipes/boardgame-promo.md；recipes/ecommerce-poster.md
检索建议：优先检索用途、媒介、构图模式、主视觉、标题层级、风格关键词

---

## Mondo 限量版丝网印刷风格专题

> 案例来源：qiaomu-mondo-poster-design（已独立化）
> 参考图片位于 `images/mondo_*.png`
> 深度风格参考：`references/poster-artist-styles.md` / `references/poster-composition-patterns.md` / `references/poster-genre-templates.md`

---

## Mondo-001：负空间极简海报（Olly Moss 风格）

**场景：** 电影海报、概念活动海报、1-2 色限量版

![mondo_example-negative-space.png](images/mondo_example-negative-space.png)

```text
[主题] in Olly Moss style Mondo poster, ultra minimalist design, clever negative
space hidden imagery within silhouette, 2-color limited palette: [color1] and
[color2], geometric simplicity, visual double meaning, symbolic object instead
of faces, Saul Bass influence, contemporary Mondo screen print aesthetic,
halftone dot texture, vintage print imperfections
```

**核心结构：** 主体剪影 + 负空间隐藏图像 + 2 色
**可迁移点：** 任何需要极简但有深度的海报，把主体替换为对应符号即可
...
![mondo_usecase-event-poster.png](images/mondo_usecase-event-poster.png)

```text
[活动名]活动海报，Mondo限量版丝网印刷风格，[核心视觉符号]，
3-color screen print: [主色], [辅色], cream，screen print aesthetic,
limited edition poster art，活动主题字体突出，halftone dot texture,
paper texture grain，竖版 [比例]
```

**核心结构：** 活动符号 + 限色丝印质感 + 日期文字层

---

## Mondo-003：公众号/文章封面图

**场景：** 微信公众号文章首图、星际穿越/人类简史风格文化类封面

![mondo_usecase-wechat-interstellar.png](images/mondo_usecase-wechat-interstellar.png)

```text
微信公众号封面图，主题：[主题]，横版 2.35:1，Mondo简化风格，
单一核心符号 [视觉元素]，背景 [主色]，
minimalist screen print aesthetic，标题文字少于10字，清晰可读，
no mockup, flat design, readable at thumbnail size
```
...
## Mondo-004：书籍封面（符号化极简风）

**场景：** 书籍封面设计、人文/科学类非虚构

![mondo_usecase-book-cover.png](images/mondo_usecase-book-cover.png)

```text
书籍封面，[书名]，[类型]，Mondo符号化风格，single symbolic hero image:
[核心图像]，[配色方案]，clear title hierarchy: book title prominent,
author name at bottom，print-ready flat design，no 3D mockup,
screen print aesthetic
```

---

## Mondo-005：Penguin Books 经典三色封面

**场景：** 经典小说、文学书籍封面

![mondo_usecase-book-v2-penguin.png](images/mondo_usecase-book-v2-penguin.png)

```text
Penguin Books classic cover design，[书名]，水平三色分割布局：
顶部 [色块：橙/红]，中间白色标题区，底部 [色块]，
Penguin企鹅标志风格，clean sans-serif typography，
bold title centered，author name below，minimal iconic illustration,
vintage 1950s British paperback aesthetic
```
...
![mondo_usecase-xiaohongshu-mood.png](images/mondo_usecase-xiaohongshu-mood.png)

```text
小红书封面图，[主题]，竖版 4:5，[情绪色调：清新/复古/高冷/治愈]，
Mondo简化丝网印刷风格，[核心视觉元素]，情绪色调突出，
[短文字钩子，不超过12字]，screen print texture,
vintage color palette，no busy background
```

---

## Mondo-007：专辑封面（Joy Division 极简风）

**场景：** 音乐专辑封面、极简黑白视觉

![mondo_usecase-album-joydivision.png](images/mondo_usecase-album-joydivision.png)

```text
专辑封面，[乐队/艺术家]，[音乐风格]，Joy Division极简风格，
极简黑白或双色构图，no text or minimal text，
pure abstract visual signal，screen print aesthetic，
1:1 square format，halftone texture，vintage print grain
```

---

## Mondo-008：专辑封面（Blue Note 爵士几何风）

**场景：** 爵士/蓝调专辑封面、几何排版感强

![mondo_album-v2-reidmiles.png](images/mondo_album-v2-reidmiles.png)

```text
专辑封面，[艺术家]，[爵士/蓝调风格]，Reid Miles Blue Note Records风格，
bold geometric typography as primary visual，[2-3色配色]，
asymmetrical modernist layout，strong sans-serif lettering，
black and white photography element integrated，1:1 square，
vintage 1950s jazz aesthetic
```
...
Doodles and handwritten notes: white and [PRIMARY_COLOR] neon ink, arrows, stars, scribbles, sketchy outlines.
Layout: Top Title + Club Career + Highlights + National Team.
...
**来源：** 用户本地整理的 Pinterest 参考图集合，已按“意向风格桌游宣传海报”筛选并去重。

**参考图：**
![boardgame-promo-concept-001.png](images/boardgame-promo-concept-001.png)
![boardgame-promo-concept-002.jpg](images/boardgame-promo-concept-002.jpg)
![boardgame-promo-concept-003.png](images/boardgame-promo-concept-003.png)
![boardgame-promo-concept-004.png](images/boardgame-promo-concept-004.png)
![boardgame-promo-concept-005.jpg](images/boardgame-promo-concept-005.jpg)
![boardgame-promo-concept-006.jpg](images/boardgame-promo-concept-006.jpg)
![boardgame-promo-concept-007.jpg](images/boardgame-promo-concept-007.jpg)
![boardgame-promo-concept-008.jpg](images/boardgame-promo-concept-008.jpg)
![boardgame-promo-concept-009.jpg](images/boardgame-promo-concept-009.jpg)
![boardgame-promo-concept-010.png](images/boardgame-promo-concept-010.png)
![boardgame-promo-concept-011.png](images/boardgame-promo-concept-011.png)
![boardgame-promo-concept-012.png](images/boardgame-promo-concept-012.png)
![boardgame-promo-concept-013.png](images/boardgame-promo-concept-013.png)
![boardgame-promo-concept-014.jpg](images/boardgame-promo-concept-014.jpg)
![boardgame-promo-concept-015.jpg](images/boardgame-promo-concept-015.jpg)

```text
桌游宣传海报，意向主视觉风格，竖版 3:4 或 4:5。
核心画面是一个高度符号化的桌游世界入口：[核心物件/角色/棋盘符号]，作为海报中心主视觉。
风格化插画，不做真实照片，不做桌面摆拍；强调装饰性构图、大色块、清晰标题层级、戏剧化剪影或图形化符号。
画面包含 1 个强主标题、1 个短副标题和少量活动/卖点信息，文字少而醒目。
构图可以使用居中对称、框中框、棋盘路径变形、物件漂浮、角色环绕、舞台海报式布局。
配色高识别，允许复古丝印、儿童冒险、奇幻、黑暗童话、侦探悬疑或游戏封面感。
输出应像成熟桌游宣传主视觉或众筹首图，而不是规则说明图、地图说明页、卡牌展示页或产品实拍。
```

**核心结构：** 强标题 + 符号化中心主视觉 + 装饰性插画 + 少量信息层级

**可迁移点：** 当用户要“桌游宣传海报、桌游众筹首图、游戏活动主视觉、概念海报”且偏插画/符号/氛围时，优先参考本集合。

**避免：** 不要加入真实桌面照片、样机、二维码、价格标签、密集规则说明、过多卡牌平铺。


---
## 例 388：桌游宣传海报｜写实主视觉参考集合

**来源：** 用户本地整理的 Pinterest 参考图集合，已按“写实风格桌游宣传海报”筛选并与意向集合去重。

**参考图：**
![boardgame-promo-realistic-001.jpg](images/boardgame-promo-realistic-001.jpg)
![boardgame-promo-realistic-002.jpg](images/boardgame-promo-realistic-002.jpg)
![boardgame-promo-realistic-003.png](images/boardgame-promo-realistic-003.png)
![boardgame-promo-realistic-004.jpg](images/boardgame-promo-realistic-004.jpg)
![boardgame-promo-realistic-005.png](images/boardgame-promo-realistic-005.png)
![boardgame-promo-realistic-006.jpg](images/boardgame-promo-realistic-006.jpg)
![boardgame-promo-realistic-007.jpg](images/boardgame-promo-realistic-007.jpg)
![boardgame-promo-realistic-008.jpg](images/boardgame-promo-realistic-008.jpg)
![boardgame-promo-realistic-009.jpg](images/boardgame-promo-realistic-009.jpg)
![boardgame-promo-realistic-010.jpg](images/boardgame-promo-realistic-010.jpg)
![boardgame-promo-realistic-011.png](images/boardgame-promo-realistic-011.png)
![boardgame-promo-realistic-012.jpg](images/boardgame-promo-realistic-012.jpg)
![boardgame-promo-realistic-013.png](images/boardgame-promo-realistic-013.png)
![boardgame-promo-realistic-014.png](images/boardgame-promo-realistic-014.png)
![boardgame-promo-realistic-015.jpg](images/boardgame-promo-realistic-015.jpg)

```text
桌游宣传海报，写实主视觉风格，竖版 3:4 或 4:5。
画面呈现一个可进入的桌游世界场景：[核心场景/角色冲突/冒险地点]，带电影海报式纵深、体积光、真实空间感和具体叙事瞬间。
可以是高质量数字绘制或半写实渲染，但不要做真实摄影照片、桌面实拍或产品样机。
主视觉要有明确前景主体、中景行动和背景环境，形成强烈的故事张力；标题清晰可读，副标题和卖点信息控制在少量。
配色与光影服务于题材：奇幻冒险、悬疑、怪物、探索、战斗、童话暗黑或家族游戏，都要有可信的材质、体积、角色表情和空间层次。
输出应像桌游盒面关键视觉、游戏主海报或电影感宣传图，而不是平面符号海报、规则说明图、卡牌拼贴或抽象排版。
```

**核心结构：** 电影感场景 + 具象角色/空间 + 真实光影体积 + 标题层级

**可迁移点：** 当用户要“写实桌游宣传海报、冒险桌游主视觉、众筹页头图、盒面级 key art”时，优先参考本集合。

**避免：** 不要使用照片级桌面摆拍、真实手持产品图、纯平面图标、过于卡通的装饰海报、密集组件展示。
