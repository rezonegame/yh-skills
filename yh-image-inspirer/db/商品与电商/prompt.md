...
适用关键词：电商、商品、产品图、主图、详情页、淘宝、京东、小红书、广告、卖点图、包装展示、商业海报
适合任务：商品主图、电商展示海报、详情页首屏、卖点图、产品参考图改造、商业发布图
不适合任务：纯角色设定、纯 UI、无商品主体的信息图、只做桌游盒面正面设计
可作为主库：最终交付物以商品销售、产品展示或电商转化为核心
可作为辅助库：为桌游宣传、海报、信息图提供产品保真、卖点层级和商业陈列逻辑
常见交叉库：海报与排版、图表与信息可视化、品牌与标志、摄影与写实
必要槽位：产品名称/品类、参考图保留锚点、海报形态、比例、卖点、是否需要 CTA
可默认槽位：默认 4:5 或 3:4；简体中文；3 个卖点；无价格/二维码/平台 logo
必须确认槽位：是否需要保留真实产品包装；目标平台/用途；文案偏销售转化还是品牌展示
优先输出形态：商品主图、展示海报、详情页、卖点图、商业 Campaign
默认比例：主图 1:1/4:5；展示海报 4:5/3:4；详情页 9:16 或长图
默认语言：默认简体中文；英文/双语仅按用户要求
常见误判：参考图是严格产品参考，不是灵感图；不要改品牌、包装、主色和关键图案
关联 recipe / template：recipes/ecommerce-poster.md；recipes/boardgame-promo.md；structured-templates.md#poster
检索建议：优先检索品类、产品形态、卖点结构、商业光影、平台用途
