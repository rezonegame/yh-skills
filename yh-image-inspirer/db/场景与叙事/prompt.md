...
适用关键词：场景、叙事、电影感、分镜、故事、世界观、环境、氛围、剧情、概念场景
适合任务：电影感叙事图、世界观场景、故事插画、宣传主视觉背景、概念场景
不适合任务：纯 UI、Logo、电商详情页、需要严谨信息模块的信息图
可作为主库：最终交付物以场景叙事或世界观氛围为核心
可作为辅助库：为海报、桌游封面、人物、插画提供背景故事和环境氛围
常见交叉库：海报与排版、人物与角色、插画与艺术、建筑与空间、历史与古风题材
必要槽位：世界观、地点、主体、情绪、镜头、时代/风格、是否需要文字
可默认槽位：默认无文字；电影感构图；比例按交付物决定
必须确认槽位：是独立场景图还是海报/封面背景；是否必须保留参考主体
优先输出形态：电影感场景、概念场景、故事插画、封面背景、分镜画面
默认比例：横向 16:9；竖版海报 4:5/9:16；方形 1:1
默认语言：默认不加文字；海报/封面需求时用简体中文
常见误判：不要让氛围背景抢走商品、标题或角色主视觉
关联 recipe / template：structured-templates.md#scene；recipes/boardgame-cover.md；structured-templates.md#poster
检索建议：优先检索场景类型、情绪、镜头、主体关系、世界观元素
...
![case108.jpg](images/case108.jpg)
...
![case109.jpg](images/case109.jpg)
...
![case145.jpg](images/case145.jpg)
...
![case146.jpg](images/case146.jpg)
...
![case147.jpg](images/case147.jpg)
...
![case148.jpg](images/case148.jpg)
