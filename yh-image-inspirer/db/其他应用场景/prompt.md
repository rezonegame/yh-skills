...
适用关键词：创意合成、趣味、混搭、梗图、缩略图、对比图、社媒封面、实验性视觉、跨界应用
适合任务：无法归入单一垂直库的综合视觉、创意合成、社交媒体缩略图、跨界玩法图
不适合任务：明确属于海报、商品、UI、人物、信息图等专门类型的任务
可作为主库：最终交付物是综合创意图且没有更准确主库
可作为辅助库：为海报、社媒图、对比图提供夸张构图或跨界视觉元素
常见交叉库：海报与排版、图表与信息可视化、插画与艺术、场景与叙事
必要槽位：用途、主体、核心冲突/创意点、文字语言、比例、禁止项
可默认槽位：社媒缩略图默认 16:9；中文少量大字；视觉冲突强
必须确认槽位：是否必须保留参考图主体；是否偏严肃商业还是娱乐传播
优先输出形态：社媒缩略图、创意合成图、对比图、梗图、跨界视觉
默认比例：缩略图 16:9；社媒海报 4:5；综合图 1:1
默认语言：按用户场景；中文用户默认简体中文
常见误判：不要把可明确路由到专门库的任务都塞进其他应用场景
关联 recipe / template：structured-templates.md#creative；structured-templates.md#poster
检索建议：优先检索创意机制、画面冲突、平台形态、主体组合
