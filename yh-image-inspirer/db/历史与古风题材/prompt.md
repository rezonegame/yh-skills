...
适用关键词：古风、历史、朝代、国潮、汉服、传统文化、新中式、文物、神话、宋代、唐代、山水、工笔
适合任务：历史题材海报、古风人物、国潮视觉、传统文化图解、古籍/卷轴风格、历史场景
不适合任务：现代商品硬广、真实 App 界面、无传统文化元素的商业摄影
可作为主库：最终交付物以历史/传统文化题材为核心
可作为辅助库：为人物、插画、海报、文档出版物、信息图提供时代语境和视觉元素
常见交叉库：人物与角色、插画与艺术、海报与排版、文档与出版物、场景与叙事
必要槽位：时代/文化来源、主体、服饰/器物、风格、文字语言、是否需史实准确
可默认槽位：默认简体中文；国风插画可默认宣纸、雅色、留白；比例按交付物决定
必须确认槽位：是否要求史实准确；是否要现代融合还是纯传统表达
优先输出形态：古风人物、国潮海报、历史场景、传统文化图解、卷轴/书籍封面
默认比例：海报 4:5/3:4；长卷 16:9 或横向；人物 3:4
默认语言：默认简体中文；书法/古籍感文字需少量且可读
常见误判：不要把所有中国风都做成红金喜庆；先看题材气质和交付物
关联 recipe / template：structured-templates.md#poster；structured-templates.md#illustration；structured-templates.md#scene
检索建议：优先检索朝代、人物类型、器物、视觉风格、用途
