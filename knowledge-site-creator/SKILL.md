...
description: "一句话生成任何领域的知识学习网站。AI自动理解主题、创作内容、生成页面、部署上线。适用于任何需要系统学习的知识领域：进化心理学、大模型术语、化学元素、历史事件等。 当用户要求依据特定主题创建一个知识学习网站、结构化网页内容或生成相关知识网时使用此技能。"user_invocable: true
---
