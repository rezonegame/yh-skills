...
description: "多源内容智能处理器：支持微信公众号、网页、YouTube、PDF、Markdown等，自动上传到NotebookLM并生成播客/PPT/思维导图等多种格式 当用户要求将内容处理并上传到 NotebookLM、生成播客或思维导图时使用此技能。"user-invocable: true
