...
### E. Motion 动效 recipe（新版必做）

模板已内置 Motion One。生成 slide 时不要只粘静态骨架，要给关键语义块加 `data-anim`：

| 页面类型 | section 写法 | 元素标记 |
|---|---|---|
| 常规正文页 | 不加 `data-animate`，默认 `cascade` | kicker / h1 / lead / stat-card / figure / rowline / pillar 加 `data-anim` |
| Hero 页 | `.hero` 自动走 `hero` recipe | kicker / h-hero / lead / meta-row 加 `data-anim` |
| 大引用 | `data-animate="quote"` | 每行 quote 用 `data-anim="line"` |
| Before/After | `data-animate="directional"` | 左列 `data-anim="left"`，右列 `data-anim="right"` |
| Pipeline | `data-animate="pipeline"` | 每个 `.step` 加 `data-anim="step"`，箭头可加 `data-anim="arrow"` |

**自检**：生成后 `grep -c 'data-anim' index.html`，应该是几十条；如果只有个位数，说明动效标记漏了。
...
<section class="slide hero dark">
  ...
  <div class="frame" style="display:grid; gap:4vh; align-content:center; min-height:80vh">
    ...
    <p class="lead" data-anim style="max-width:60vw">
...
<section class="slide light">
  ...
  <div class="frame" style="padding-top:6vh">
    ...
    <p class="lead" data-anim style="margin-bottom:5vh">从 0 到开源 CodePilot。</p>
  ...
  <div class="frame grid-2-7-5" style="padding-top:6vh">
    ...
    <div style="display:flex; flex-direction:column; justify-content:space-between; gap:3vh">
      <div>
        ...
        <h2 class="h-xl" data-anim style="white-space:nowrap; font-size:7.2vw">
          我不是程序员。
        </h2>
        <p class="lead" data-anim style="margin-top:3vh">
    ...
    <figure class="frame-img" data-anim style="aspect-ratio:16/10; max-height:56vh">
...
<section class="slide light" data-animate="pipeline">
  ...
  <div class="frame">
    ...
    <h2 class="h-xl" data-anim>两条流水线</h2>
...
<section class="slide light" data-animate="quote">
  ...
  <div class="frame" style="display:grid; gap:5vh; align-content:center; min-height:80vh">
    ...
    <p class="lead" data-anim style="max-width:55vw; opacity:.65">
...
<section class="slide light" data-animate="directional">
  ...
  <div class="frame" style="padding-top:5vh">
    ...
    <h2 class="h-xl" data-anim style="margin-bottom:4vh">从交接到共建</h2>
