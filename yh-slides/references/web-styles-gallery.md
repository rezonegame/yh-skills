...
| Source | 可用字体 | CDN |
|--------|---------|-----|
| Google Fonts | Archivo Black, Space Grotesk, Manrope, Syne, Cormorant, Bodoni Moda, DM Sans, Plus Jakarta Sans, Outfit, Fraunces, Work Sans, JetBrains Mono, Montserrat, Open Sans, Playfair Display, Merriweather, Nunito, Oswald, Baloo 2, Fredoka One, Poppins | `fonts.googleapis.com` |
