...
# Fallback for Windows: add common pip user-install path to PATH
if sys.platform == "win32":
    for v in ["13", "12", "11", "10", "9"]:
        fallback_path = os.path.expanduser(fr"~\AppData\Roaming\Python\Python3{v}\Scripts")
        if os.path.exists(fallback_path) and fallback_path not in os.environ.get("PATH", ""):
